...
import AgentDetailMainRight from './AgentDetailComponents/AgentDetailMainRight/AgentDetailMainRight';
...
const AgentDetail = () => {
  ...
  return (
    <div className=" bg-background flex flex-col h-[calc(100vh-200px)] ">
      {/* Navbar Component */}
      <AgentDetailNavbar
        agentName={agentName}
