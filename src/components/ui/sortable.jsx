...
function KanbanColumn({ value, className, children, disabled }) {
  const {
    setNodeRef,
    transform,
    transition,
...
function KanbanColumnHandle({ asChild, className, children, cursor = true }) {
...
function KanbanItem({ value, asChild = false, className, children, disabled }) {
  const {
    setNodeRef,
    transform,
    transition,
...
function SortableItemHandle({ asChild, className, children, cursor = true }) {
